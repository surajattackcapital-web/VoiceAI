...
const DATIntegrationPage: React.FC = () => {
  const features = [
    {
  ...
  const faqs = [
    {
      question: "Does Voice AI integrate natively with DAT's load board platform?",
      answer: "Yes. Voice AI connects directly to DAT's API, enabling seamless load posting, carrier matching, and real-time market data access."
    },
    {
      question: "Can Voice AI handle load matching and carrier communication automatically?",
      answer: "Absolutely. The AI can post loads, match carriers, handle negotiations, and automatically update all load information in DAT's system through voice interactions."
    },
    {
  ...
  return (
    <Layout 
      title="DAT Integration | Voice AI for Load Board Management" 
      description="Connect Voice AI with DAT to automate load posting, handle carrier matching, and streamline freight brokerage operations. Built for freight brokers and logistics companies that want intelligent load board automation and better carrier management."
    >
      {/* Hero Section */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-[var(--muted)] leading-relaxed mb-8">
              Voice AI integrates seamlessly with DAT's load board platform to create an intelligent freight matching 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)] max-w-4xl mx-auto">
              DAT provides comprehensive load board services, but adding Voice AI transforms load management into an 
            ...
            {[
              {
                ...
                description: 'Voice AI handles load posting, carrier matching, and rate negotiations through intelligent automation powered by DAT\'s load board platform.'
              },
              {
      ...
      <section className="py-20 bg-[var(--bg-2)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)]">
              Real improvements from integrating Voice AI with DAT.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)]">
              Get started with Voice AI and DAT integration in minutes.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[var(--accent-1)] to-[var(--accent-2)]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8">
            Start automating your load management and carrier matching with Voice AI and DAT integration.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
...
export default DATIntegrationPage;