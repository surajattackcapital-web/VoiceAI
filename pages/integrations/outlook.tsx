...
const OutlookIntegrationPage: React.FC = () => {
  const features = [
    {
  ...
  const faqs = [
    {
      question: "Does Voice AI integrate natively with Outlook's email platform?",
      answer: "Yes. Voice AI connects directly to Outlook's API, enabling seamless email management, composition, and real-time communication data access."
    },
    {
      question: "Can Voice AI handle email composition and customer communication automatically?",
      answer: "Absolutely. The AI can compose emails, manage responses, handle customer inquiries, and automatically update all email information in Outlook through voice interactions."
    },
    {
  ...
  return (
    <Layout 
      title="Outlook Integration | Voice AI for Email Management" 
      description="Connect Voice AI with Outlook to automate email composition, handle intelligent responses, and streamline business communication. Built for logistics companies that want intelligent email automation and better customer communication."
    >
      {/* Hero Section */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-[var(--muted)] leading-relaxed mb-8">
              Voice AI integrates seamlessly with Outlook to create an intelligent email management 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)] max-w-4xl mx-auto">
              Outlook provides powerful email management, but adding Voice AI transforms email communication into an 
            ...
            {[
              {
                ...
                description: 'Voice AI handles email writing, response generation, and customer communication through intelligent automation powered by Outlook\'s platform.'
              },
              {
      ...
      <section className="py-20 bg-[var(--bg-2)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)]">
              Real improvements from integrating Voice AI with Outlook.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--muted)]">
              Get started with Voice AI and Outlook integration in minutes.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[var(--accent-1)] to-[var(--accent-2)]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8">
            Start automating your email composition and customer communication with Voice AI and Outlook integration.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
